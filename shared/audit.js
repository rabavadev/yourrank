...
export async function logAudit(entry) {
    ...
    try {
        await exec(`INSERT INTO audit_log (actor_id, action, entity_type, entity_id, details, ip_address, user_agent)
       VALUES ($1, $2, $3, $4, $5::jsonb, $6, $7)`, [actorId || null, action, entityType || null, entityId || null, safeDetails, ipAddress, userAgent]);
    }
    catch (err) {
