...
const DASHBOARD_NAV: (NavItem | { group: string })[] = [
  ...
  { group: "LEADERBOARD" },
  { key: "board", label: "Players & scores", href: "/dashboard/editor/players", icon: NAV_ICONS.players, hash: "players" },
  ...
  { key: "viewers", label: "Viewers", href: "/dashboard/audience/viewers", icon: NAV_ICONS.viewers },
  { key: "telegram", label: "Telegram bot", href: "/dashboard/telegram", icon: NAV_ICONS.share },
  { group: "SETTINGS & SITES" },
  { key: "boards", label: "Sites & connected apps", href: "/dashboard/boards", icon: NAV_ICONS.boards },
