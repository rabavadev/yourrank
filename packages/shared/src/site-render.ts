...
import { brandPoweredByHtml } from "@yourrank/shared/brand-assets";
...
<p class="yr-fine">&copy; ${new Date().getFullYear()} ${esc(b.name || slug)}.${watermark ? ` <a class="yr-powered-by-link" href="${esc(homeUrl || "/")}" target="_blank" rel="noopener">${brandPoweredByHtml({ className: "yr-powered-by yr-powered-by--footer" })}</a>.` : ""}</p>
</footer>`;
}
