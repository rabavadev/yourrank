...
export const metadata: Metadata = {
  ...
  description: "Launch a branded community site with live standings, offers, games, rewards, and an OBS-ready overlay.",
...
export default function SitesPage() {
  return <ProductPage content={{
    ...
    intro: "Publish a branded destination where viewers can follow standings, discover offers, play, and reach their rewards without losing the thread.",
    outcome: "From a blank page to a live community destination.",
    steps: [
      { number: "01", title: "Choose the experience", body: "Set the public sections your viewers need: home content, leaderboard, shop, games, and viewer access." },
