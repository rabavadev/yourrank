...
export function overviewPanel(): string {
  ...
  <div class="panel" data-page="overview"><div class="cardhd"><h2>Finish setup</h2></div>
    <div class="steps" id="ovSetup">
      ...
      <div class="step" id="stepPb"><div class="n">STEP 3</div><div class="t">Track deposits</div><div class="d">See which clicks turn into deposits \u2014 set it up in <a href="/dashboard/settings/connections">Settings → Integrations</a>.</div></div>
    </div>
  </div>`;
}
