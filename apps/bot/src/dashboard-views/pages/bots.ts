...
export function botsPanel(): string {
  ...
  <div class="panel" data-page="bots"><h2>Your bots</h2>
    ...
    <div class="wizard" id="connectWizard">
      ...
      <div class="wizard-step" data-step="2" hidden>
        ...
        <div class="field-row">
          <input class="grow" id="botToken" type="password" autocomplete="off" placeholder="123456:ABC-...">
  ...
  <div class="panel" data-page="bots" id="testMsgPanel" hidden>
    ...
    <p class="muted panel-intro">Send a one-off message from <b id="tmBotName">your bot</b> to confirm it works. Get your chat ID by sending <code>/start</code> to <a href="https://t.me/userinfobot" target="_blank" rel="noopener">@userinfobot</a>.</p>
    <div class="row">
