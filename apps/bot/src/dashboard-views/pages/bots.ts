...
export function botsPanel(): string {
  ...
  <div class="lb-bento" data-page="bots">
      ...
      <div class="wizard mt-lg" id="connectWizard">
        ...
        <div class="wizard-step" data-step="2" hidden>
          ...
          <div class="d-flex flex-col gap-8 mt-sm bot-connect-fields">
            ...
            <div class="d-flex gap-8 mt-sm">
              <button class="btn btn--accent" data-action="connectBot" type="button">Connect bot</button>
    ...
    <div class="lb-widget lb-widget--full" id="testMsgPanel" hidden>
      ...
      <p class="muted mb-md">Send a one-off message from <b id="tmBotName">your bot</b> to confirm it works. Get your chat ID by sending <code>/start</code> to <a href="https://t.me/userinfobot" target="_blank" rel="noopener">@userinfobot</a>.</p>
