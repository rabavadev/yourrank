...
function setupShareWorkspace() {
  ...
  const viewers = makeSection("Share with viewers", "Copy your public link or share it with your community.", "editor-share-viewers");
  viewers.append(publicField, shareCards);

  const stream = makeSection("On my stream", "Use the overlay link when you want the leaderboard inside your broadcast.", "editor-share-stream");
