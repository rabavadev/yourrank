...
function setAriaCurrentNav(page){
  document.querySelectorAll(".lb-nav").forEach(n => { const active = n.dataset.nav === page; n.classList.toggle("is-on", active); n.setAttribute("aria-current", active ? "page" : "false"); });
}
function navTo(page){
...
||||||| parent of e104b39 (feat: split dashboard.js into ES modules and serve nested assets)
function renderBoardSwitcher(){
  const list = $("boardList");
  if (list) {
    list.innerHTML = "";
...
=======
>>>>>>> e104b39 (feat: split dashboard.js into ES modules and serve nested assets)
init();
