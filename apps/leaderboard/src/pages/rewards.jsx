...
<div class="lb-main"><header class="lb-topbar" id="lbTopbar"><a class="lb-brand" href="/dashboard" aria-label="YourRank dashboard"><span class="lb-brand-mark">Y</span><span class="lb-brand-txt">YourRank</span></a><div class="lb-topbar-hud"><div class="lb-board-select-wrap"><span class="lb-board-select-lbl">Board:</span><select class="lb-board-select" id="sidebarBoardSelect" aria-label="Switch board"></select></div></div><div class="lb-topbar-actions"><span class="lb-status" id="lbTopbarStatus">—</span><span class="lb-avatar" id="userAvatar" aria-label="Account">Y</span></div></header><div class="lb-phead"><button class="lb-menu" id="lbMenu" type="button" aria-label="Show sections" aria-expanded="false" aria-controls="lbSide">☰</button></div><main class="lb-bento" id="cr-main"><div id="cr-loading" class="ui-loading" hidden><div class="ui-loading__spinner"></div></div><div id="cr-app" data-cr-tab="${activeTab}" hidden>${body}</div><div id="cr-empty" class="empty" hidden><p>Loading your credits dashboard…</p></div></main></div></div></div>`;
}
