...
<p>As long as your account exists. You can download a copy of your data at any time from <a href="/dashboard?nav=settings">Dashboard → Settings</a> (GDPR/CCPA data export). Want your account deleted? Go to <a href="/dashboard?nav=settings">Dashboard → Plan &amp; billing → Danger zone</a> and click "Delete my account."</p>
