...
<div class="ov-setup-row" id="ovStepBrand"><span class="ov-step-icon" id="ovStepBrandMark" data-num="1"></span><div class="ov-step-body"><b>Name your board</b><span class="hint">Set up your custom display name for this event series</span></div><span class="ov-step-status" id="ovStepBrandStatus">TODO</span></div>
<div class="ov-setup-row" id="ovStepPlayers"><span class="ov-step-icon" id="ovStepPlayersMark" data-num="2"></span><div class="ov-step-body"><b>Add players</b><span class="hint">Import list of streamers or enter manually to populate leaderboard</span></div><span class="ov-step-status" id="ovStepPlayersStatus">TODO</span></div>
<div class="ov-setup-row" id="ovStepKick"><span class="ov-step-icon" id="ovStepKickMark" data-num="3"></span><div class="ov-step-body"><b>Connect Kick channel</b><span class="hint">Link streamer Kick API for automated wager tracking</span></div><span class="ov-step-status" id="ovStepKickStatus">TODO</span></div>
<div class="ov-setup-row" id="ovStepConfigure"><span class="ov-step-icon" id="ovStepConfigureMark" data-num="4"></span><div class="ov-step-body"><b>Configure your page</b><span class="hint">Customize layouts, visual branding, and prize announcements</span></div><span class="ov-step-status" id="ovStepConfigureStatus">TODO</span></div>
<div class="ov-setup-row" id="ovStepPublish"><span class="ov-step-icon" id="ovStepPublishMark" data-num="5"></span><div class="ov-step-body"><b>Publish</b><span class="hint">Make your leaderboard publicly accessible to viewers</span></div><span class="ov-step-status" id="ovStepPublishStatus">TODO</span></div>
