...
<div class="kpi-row"><div class="kpi-card"><span class="kpi-lbl">Pending redemptions</span><div class="kpi-value-row"><span class="kpi-val" id="ovPendingRedemptions"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></span><a class="kpi-action" href="/dashboard/rewards/redemptions">View queue →</a></div></div><div class="kpi-card"><span class="kpi-lbl">Page views (14d)</span><div class="kpi-value-row"><span class="kpi-val" id="ovViews14"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></span><span id="ovViewsDelta"></span></div></div><div class="kpi-card"><span class="kpi-lbl">Referral copies (14d)</span><div class="kpi-value-row"><span class="kpi-val" id="ovCopies14"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></span><span id="ovCopiesDelta"></span></div></div></div>
...
<div class="card" data-egroup="history"><h2>Past periods</h2><p class="card-sub">Close out finished periods and see past winners. Saves your unsaved edits first.</p>
<div class="arch-form">
...
<div class="v3-analytics-page">
  ...
  <div class="v3-kpi-grid">
    ...
    <div class="v3-kpi-card"><div class="v3-kpi-label">CTA CLICKS <span title="Clicks on your tracked referral or share links." aria-label="Metric help">[?]</span></div><div class="v3-kpi-value-row"><strong id="perfKpiClicks"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></strong><span class="v3-delta" id="perfKpiClicksDelta"></span></div></div>
    <div class="v3-kpi-card"><div class="v3-kpi-label">REF COPIES <span title="Times a visitor copied your public link to the clipboard." aria-label="Metric help">[?]</span></div><div class="v3-kpi-value-row"><strong id="perfKpiCopies"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></strong><span class="v3-delta" id="perfKpiCopiesDelta"></span></div></div>
    <div class="v3-kpi-card"><div class="v3-kpi-label">CTR <span title="Click-through rate: clicks divided by views in the selected range." aria-label="Metric help">[?]</span></div><div class="v3-kpi-value-row"><strong id="perfKpiCtr"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></strong><span class="v3-delta" id="perfKpiCtrDelta"></span></div></div>
  </div>
  <div class="v3-perf-panel" data-perf-panel="activity" id="perf-activity">
    <div class="v3-table-card v3-chart-card"><div class="v3-card-head"><h2>Views over time</h2><span class="v3-chart-total">Total views: <b id="perfTotalViews"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></b></span></div><div id="statBars" class="v3-line-chart" role="img" aria-label="Daily views over time"></div><div class="v3-empty" id="statsEmpty" hidden></div></div>
    ...
    <div class="v3-table-card" id="perf-heatmap"><div class="v3-card-head"><div><h2>Activity map</h2><p class="v3-head-sub">Views by day and hour (last 30 days).</p></div></div><div class="heatmap-wrap"><div class="heatmap" id="perfHeatmapGrid"><span class="skeleton v3-skel-heatmap" aria-hidden="true"></span></div></div></div>
  </div>
  <div class="v3-perf-panel" data-perf-panel="referrals" id="perf-referrals" hidden>
    <div class="v3-table-card"><div class="v3-card-head"><div><h2>Referrals</h2><p class="v3-head-sub">Share your link. Every sign-up adds 31 days of Pro.</p></div></div><div class="v3-ref-link-row"><input id="refLink" readonly value="" /><button class="v3-btn v3-btn--accent" id="refCopy" type="button">Copy link</button></div><div class="v3-stat-tiles"><div><b id="refCount"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></b><span>People signed up</span></div><div><b id="refDays"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></b><span>Free days earned</span></div><div><b id="refSaved"><span class="skeleton v3-skel-kpi" aria-hidden="true"></span></b><span>Value earned ($)</span></div></div><p id="refStatus" role="status" aria-live="polite"></p></div>
