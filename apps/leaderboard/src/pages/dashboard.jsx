...
<div class="ov-setup-row" id="ovStepBrand"><span class="ov-step-icon" id="ovStepBrandMark"></span><div class="ov-step-body"><b>Name your board</b><span class="hint">Set up your custom display name for this event series</span></div><span class="ov-step-status" id="ovStepBrandStatus">TODO</span></div>
<div class="ov-setup-row" id="ovStepPlayers"><span class="ov-step-icon" id="ovStepPlayersMark"></span><div class="ov-step-body"><b>Add players</b><span class="hint">Import list of streamers or enter manually to populate leaderboard</span></div><span class="ov-step-status" id="ovStepPlayersStatus">TODO</span></div>
