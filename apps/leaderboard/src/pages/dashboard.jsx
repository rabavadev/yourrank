...
const TAB_LABELS = {
  setup: "Site details", players: "Players & scores", design: "Theme & styling", share: "Overlay & share", history: "Past winners",
...
<div class="card" data-egroup="design" id="sectionsCard"><h2>Layout &amp; blocks <span class="pill pill--info ml-6">PRO</span></h2><p class="card-sub">Choose what appears on your public page.</p>
...
<div class="card" data-egroup="design" id="prizesCard"><h2>Prize labels <span class="pill pill--info ml-6">PRO</span></h2><p class="card-sub">Customize the text labels shown next to prizes and the countdown timer.</p>
<div id="prizesBody">
<div class="grid2">
...
<div class="card" data-egroup="design" id="socialsCard"><h2>Social links</h2><p class="card-sub">Add your social media profiles. Toggle each one on or off to control what appears on your page.</p>
...
<div class="card" data-egroup="history"><h2>Past winners</h2><p class="card-sub">End a competition period and save the results. Your current leaderboard will be archived before any changes are made.</p>
<div class="arch-form">
...
<div class="v3-analytics-page">
  <header class="v3-head"><h1>Traffic &amp; analytics</h1><p class="v3-head-sub">See how viewers find and interact with your site.</p></header>
  ...
  <nav class="v3-tabs" aria-label="Audience insight sections">
    <a class="v3-tab" href="/dashboard/analytics/activity" data-perf-tab="activity">Traffic &amp; activity</a>
    <a class="v3-tab" href="/dashboard/analytics/referrals" data-perf-tab="referrals">Referral program</a>
    <a class="v3-tab" href="/dashboard/analytics/events" data-perf-tab="events">System log</a>
  </nav>
  ...
  <div class="v3-perf-panel" data-perf-panel="referrals" id="perf-referrals" hidden>
    ...
    <div class="v3-table-card" id="perf-referrers"><div class="v3-card-head"><h2>Where your visitors come from</h2></div><div class="v3-table-scroll"><table class="v3-table"><thead><tr><th>DOMAIN</th><th class="num">VISITS</th></tr></thead><tbody id="perfReferrersBody"></tbody></table></div><p class="v3-empty-copy" id="perfReferrersEmpty" hidden>No traffic sources yet. Add <code>?ref=source</code> to your share link to track where visitors come from.</p></div>
  </div>
...
<div class="v3-settings">
  ...
  <section class="v3-settings-panel" id="settingsPanelAccess" role="tabpanel" aria-labelledby="settingsTabAccess" data-settings-panel="access">
    ...
    <div class="v3-settings-card"><div class="v3-settings-row v3-settings-row--top"><div><h2>Discord notifications <span class="v3-chip v3-chip--pro">PRO</span></h2><p>Get a Discord message when your leaderboard resets or a player reaches the top 3.</p></div><input class="v3-toggle" id="settingsWebhookEnabled" type="checkbox" aria-label="Enable Discord notifications" /></div><div class="v3-settings-notify-body" id="notifyBody"><div class="v3-settings-inline-form"><input id="f_webhook" aria-label="Discord connection URL" placeholder="Paste your Discord connection link here" /><button class="v3-set-btn v3-set-btn--outline" id="testDiscord" type="button">Send test message</button><span class="v3-settings-status" id="testDiscordStatus" role="status"></span></div><p class="v3-settings-muted">In Discord, open Channel settings → Integrations → Webhooks, then choose Copy Webhook URL.</p></div><div class="v3-settings-inline" id="notifyLock" hidden>Notifications are a Pro feature. <a href="/dashboard/settings/plan?from=notifications">Upgrade to unlock them</a>.</div></div>
