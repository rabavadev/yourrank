...
<div class="v3-settings">
  ...
  <section class="v3-settings-panel" id="settingsPanelPlan" role="tabpanel" aria-labelledby="settingsTabPlan" data-settings-panel="plan">
    <div class="v3-settings-card v3-plan-card"><div><div class="v3-settings-card-kicker">CURRENT PLAN</div><div class="v3-settings-plan-row"><span class="v3-chip v3-chip--pro" id="settingsPlanChip">FREE</span><span class="v3-settings-price" id="settingsPlanPrice">—</span></div><p class="v3-settings-card-sub" id="settingsPlanRenewal">Your current plan is active.</p></div><a class="v3-btn v3-btn--dark" href="/account/plan" id="settingsManagePlan">Manage subscription</a></div>
    <div class="v3-settings-card"><div class="v3-settings-card-head"><div><h2>Platform Limits</h2><p>Usage across your boards and rewards products.</p></div></div><div class="v3-meter-grid" id="settingsUsage"><p class="v3-empty">Loading usage…</p></div></div>
    <div class="v3-settings-card"><div class="v3-settings-card-head"><div><h2>Account Providers &amp; Schedulers</h2><p>Control how viewers connect and how your board sends updates.</p></div></div><div class="v3-settings-group-label">VIEWER LOGIN PROVIDERS</div><div class="v3-settings-row"><div><b>Kick</b><p>Allow viewers to log in with Kick.</p></div><input class="v3-toggle" id="settingsKickLogin" type="checkbox" aria-label="Allow viewers to log in with Kick" disabled /><a class="v3-btn v3-btn--outline" href="/dashboard/rewards/channel">Configure</a></div><div class="v3-settings-row"><div><b>Discord</b><p>Connect Discord notifications and viewer login.</p></div><a class="v3-btn v3-btn--outline" href="#settingsPanelSecurity" data-settings-jump="security">Configure</a></div></div>
  </section>
  <section class="v3-settings-panel" id="settingsPanelAccount" role="tabpanel" aria-labelledby="settingsTabAccount" data-settings-panel="account" hidden>
    <div class="v3-settings-card"><div class="v3-settings-card-head"><div><h2>Account security</h2><p>Update your password and review active sessions.</p></div></div><div class="v3-settings-form-grid"><label>Current password<input type="password" id="accCurrentPassword" autocomplete="current-password" /></label><label>New password<input type="password" id="accNewPassword" autocomplete="new-password" minlength="8" /></label></div><div class="v3-settings-actions"><button class="v3-btn v3-btn--dark" id="accChangePassword" type="button">Update password</button><span class="v3-settings-status" id="accPasswordStatus" role="status"></span></div><div class="v3-settings-divider"></div><div class="v3-settings-row"><div><b>Active sessions</b><p>Sign out every other device while keeping this one active.</p></div><button class="v3-btn v3-btn--outline" id="accRevokeSessions" type="button">Sign out other sessions</button></div><div id="accSessions" class="v3-settings-sessions"><p class="v3-settings-muted">Loading…</p></div><p class="v3-settings-status" id="accSessionsStatus" role="status"></p></div>
    <div class="v3-settings-card"><div class="v3-settings-card-head"><div><h2>Integrations</h2><p>Stream tools, postbacks, Kick rewards and legal pages.</p></div></div><div class="v3-settings-row"><div><b>Kick rewards</b><p>Let viewers earn credits by redeeming Kick channel rewards.</p><span class="v3-settings-muted" id="kickStatus">Loading…</span></div><a class="v3-btn v3-btn--outline" href="/dashboard/credits" id="kickRewardsLink">Open Kick rewards</a></div><div class="v3-settings-row"><div><b>Postbacks</b><p id="postbackStatus">Receive automatic score updates from your sponsor.</p></div><a class="v3-btn v3-btn--outline" href="/account/postbacks">Manage postbacks</a></div><div class="v3-settings-divider"></div><div class="v3-settings-legal"><h3>Compliance</h3><div id="legalList"></div><div id="legalFooterPreview" class="v3-settings-muted"></div></div></div>
  </section>
  <section class="v3-settings-panel" id="settingsPanelSecurity" role="tabpanel" aria-labelledby="settingsTabSecurity" data-settings-panel="security" hidden>
    <div class="v3-settings-card"><div class="v3-settings-row v3-settings-row--top"><div><h2>Password Protection</h2><p>Visitors must enter this password before seeing the leaderboard or using the public API.</p></div><input class="v3-toggle" id="settingsPasswordEnabled" type="checkbox" aria-label="Enable password protection" /></div><div class="v3-settings-inline-form"><input id="settingsPassword" type="password" placeholder="Leave blank to keep current password" autocomplete="new-password" /><button class="v3-btn v3-btn--dark" id="settingsPasswordSave" type="button">Update password</button><span class="v3-settings-status" id="settingsPasswordStatus" role="status"></span></div></div>
    <div class="v3-settings-card"><div class="v3-settings-row v3-settings-row--top"><div><h2>Webhook Notifications <span class="v3-chip v3-chip--pro">PRO</span></h2><p>Receive alerts when your leaderboard resets or a player reaches the top 3.</p></div><input class="v3-toggle" id="settingsWebhookEnabled" type="checkbox" aria-label="Enable webhook notifications" /></div><div class="v3-settings-notify-body" id="notifyBody"><label class="v3-settings-label" for="f_webhook">Discord webhook URL</label><input id="f_webhook" placeholder="https://discord.com/api/webhooks/..." /><div class="v3-settings-actions"><button class="v3-btn v3-btn--outline" id="testDiscord" type="button">Test webhook</button><span class="v3-settings-status" id="testDiscordStatus" role="status"></span></div><div class="v3-settings-secondary"><label class="v3-settings-label" for="f_tgChatId">Telegram chat/group ID</label><input id="f_tgChatId" placeholder="-1001234567890" /><label class="v3-settings-check"><input type="checkbox" id="f_tgNotify" /> Enable Telegram notifications</label><button class="v3-btn v3-btn--outline" id="testTelegram" type="button">Test Telegram</button><span class="v3-settings-status" id="testTelegramStatus" role="status"></span></div></div><div class="v3-empty" id="notifyLock" hidden>Notifications are a Pro feature. <a href="/account/plan?from=notifications">Upgrade to unlock them</a>.</div></div>
    <div class="v3-settings-card v3-danger-card"><div class="v3-danger-lbl">DANGER ZONE</div><div class="v3-settings-row"><div><b>Reset All Leaderboard Data</b><p>Archive the current period and clear its players or wagers.</p></div><button class="v3-btn v3-btn--danger-outline" id="settingsResetData" type="button">Reset data</button></div><div class="v3-settings-row"><div><b>Delete this board</b><p>Permanently delete this board and all of its data.</p></div><button class="v3-btn v3-btn--danger" id="settingsDeleteBoard" type="button">Delete board</button></div></div>
  </section>
  <section class="v3-settings-panel" id="settingsPanelDomain" role="tabpanel" aria-labelledby="settingsTabDomain" data-settings-panel="domain" hidden><div class="v3-settings-card"><div class="v3-settings-card-head"><div><h2>Custom Domain</h2><p>Point your domain to your public board and provision TLS.</p></div></div><div id="domainBody"><label class="v3-settings-label" for="f_domain">Your domain</label><input id="f_domain" placeholder="board.mystream.com" /><p class="v3-settings-muted">Point a CNAME record to <span class="mono">yourrank.site</span>, then verify.</p><button class="v3-btn v3-btn--dark" id="domainVerify" type="button">Verify &amp; Provision TLS</button><div id="domainStatus" class="v3-settings-status" role="status"></div></div><div class="v3-empty" id="domainLock" hidden>Custom domains are a Pro feature. <a href="/account/plan?from=domain">Upgrade to unlock it</a>.</div></div></section>
  <section class="v3-settings-panel" id="settingsPanelSupport" role="tabpanel" aria-labelledby="settingsTabSupport" data-settings-panel="support" hidden><div class="v3-settings-card"><div class="v3-settings-card-head"><div><h2>Support &amp; Resources</h2><p>Find help and manage the tools around your public board.</p></div></div><div class="v3-settings-row"><div><b>OBS Overlay</b><p>Copy the overlay URL, embed code and share links.</p></div><a class="v3-btn v3-btn--outline" href="/dashboard/editor/share">Open Board → Share</a></div><div class="v3-settings-row"><div><b>Need help?</b><p>Contact support or read the YourRank documentation.</p></div><a class="v3-btn v3-btn--outline" href="/help/support">Contact support</a></div></div></section>
</div>
</section>
<section class="lb-page" data-page="settings-legacy" hidden>
<div class="lb-phead"><button class="lb-menu" type="button" aria-label="Show sections" data-menu aria-expanded="false" aria-controls="lbSide">☰</button></div>
<div class="lb-bento">
