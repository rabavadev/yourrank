...
const faqs = [
  ...
  { q: "Is YourRank free?", a: "Yes. The Free plan includes one leaderboard with up to 10 players, one Telegram bot, three tracked offers, three credit rules, and five items. Paid plans add more of each product, plus custom domains, OBS overlays, and API access." },
  ...
  { q: "Can viewers log in?", a: "Yes. Streamers can enable Kick or Discord OAuth for their board. Viewers then log in at /me to see their balance across boards and redeem items." },
