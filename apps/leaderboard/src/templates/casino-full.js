...
`;
export function composeCandy(_p) { return `<div class="min-h-screen bg-gradient-to-b from-[#FF85B3] to-[#C084FC] text-white font-sans overflow-x-hidden flex flex-col items-center pb-20 selection:bg-[#FF1493] selection:text-white"><div class="w-full relative bg-[#FF1493] shadow-[0_10px_30px_rgba(255,20,147,0.3)] border-b-[6px] border-white z-20"><div class="absolute inset-0 opacity-100 pointer-events-none [background-image:repeating-linear-gradient(45deg,_transparent,_transparent_15px,_rgba(255,255,255,0.15)_15px,_rgba(255,255,255,0.15)_30px)]"></div><div class="relative z-10 max-w-4xl mx-auto px-4 py-8 md:py-12 flex flex-col items-center text-center"><div class="flex items-center gap-2 md:gap-4 mb-2"><span class="text-4xl md:text-6xl animate-bounce [animation-duration:2s]">ðŸ­</span><h1 class="text-5xl md:text-7xl tracking-wide text-[#ffed4d] [font-family:'Fredoka_One',_cursive] [text-shadow:0_6px_0_#D81B60,_0_10px_15px_rgba(0,0,0,0.3)]">SWEET JACKPOT</h1><span class="text-4xl md:text-6xl animate-bounce [animation-duration:2s] [animation-delay:0.2s]">ðŸ­</span></div><p class="text-white text-xl md:text-2xl font-bold tracking-wider mt-4 mb-10 drop-shadow-[0_2px_2px_rgba(216,27,96,0.8)] [font-family:'Fredoka_One',_cursive]">ðŸ¬ The sweetest winners on the floor! ðŸ¬</p><div class="flex gap-3 bg-white/30 p-2.5 rounded-full border-4 border-white/50 shadow-[inset_0_4px_10px_rgba(0,0,0,0.1)] backdrop-blur-md"><button class="px-6 py-2.5 rounded-full font-bold text-sm md:text-base transition-all border-4 bg-[#00E676] text-white shadow-[0_6px_0_#00B25A] border-white hover:-translate-y-0.5 hover:shadow-[0_8px_0_#00B25A] [font-family:'Fredoka_One',_cursive]">HOURLY</button><button class="px-6 py-2.5 rounded-full font-bold text-sm md:text-base transition-all border-4 bg-[#FF1493] text-white shadow-[0_6px_0_#C51162] border-white scale-105 -translate-y-1 [font-family:'Fredoka_One',_cursive]">TODAY</button><button class="px-6 py-2.5 rounded-full font-bold text-sm md:text-base transition-all border-4 bg-[#00E676] text-white shadow-[0_6px_0_#00B25A] border-white hover:-translate-y-0.5 hover:shadow-[0_8px_0_#00B25A] [font-family:'Fredoka_One',_cursive]">ALL TIME</button></div></div></div><div class="max-w-4xl w-full px-4 mt-16 md:mt-24 flex flex-col items-center"><div data-top3=""></div><div data-rows=""></div><div class="mt-20 mb-10 text-center flex flex-col items-center gap-4"><div class="text-5xl animate-bounce [animation-duration:2s]">ðŸ§</div><p class="text-white text-2xl md:text-4xl tracking-wide drop-shadow-[0_4px_4px_rgba(0,0,0,0.2)] [font-family:'Fredoka_One',_cursive] [text-shadow:0_4px_0_#C084FC]">ðŸ° Keep Playing, Sweet Winner! ðŸ°</p></div></div></div>`; }
