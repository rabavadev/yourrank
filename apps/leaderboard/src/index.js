...
const MARKETING_PAGES = new Set(["/", "/index.html", "/sites", "/telegram", "/credits", "/pricing", "/overlays", "/games", "/switch", "/changelog", "/brand", "/status"]);
const NON_SITE_PATHS = new Set([
  ...
  "responsible", "refund", "setup", "demo", "sites", "telegram", "credits", "pricing", "overlays", "games", "switch", "go", "logo", "favicon.ico",
